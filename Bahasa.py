...
input_bahasa = ["Hello, how are you?",
	"Guten Tag, wie geht es dir?",
	"Allo comment vas-tu?",
	"नमस्कार क्या हालचाल हैं?",
	"Hallo, apa kabar",
	"Hallo, hvordan går det?",
]

lemmatizer_names = ["Language Code", "Input bahasa"]
format_text = '{:30}' * (len(lemmatizer_names) + 1)

print ('\n', format_text.format("Language Name", *lemmatizer_names),'\n','='*120)
for data in input_bahasa:
    language_code = detect(data)
    sentence = [code_bahasa.get(language_code), language_code, data]
